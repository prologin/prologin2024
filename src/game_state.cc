    ...
    : rules::GameState(players)
{
    ...
    joueurs.emplace_back(0, TOUR_GAINS_ACTION, aigles1, villages1);
    ...
    joueurs.emplace_back(0, TOUR_GAINS_ACTION, aigles2, villages2);
...
void GameState::debute_tour(int joueur)
{
    historiques[0].clear();
    historiques[1].clear();
    joueurs[joueur].points_action = TOUR_GAINS_ACTION;
    // FIXME
}
