...
extern "C" erreur api_activer_aigle(int id) { return api->activer_aigle(id); }

extern "C" erreur api_deplacer_aigle(int id, position destination) {
  return api->deplacer_aigle(id, destination);
}

extern "C" dimension api_dimensions_carte() { return api->dimensions_carte(); }

extern "C" etat_case api_info_case(position pos) { return api->info_case(pos); }

extern "C" std::vector<aigle> api_info_aigles() { return api->info_aigles(); }
...
extern "C" int api_score(int joueur) { return api->score(joueur); }
...
extern "C" int api_moi() { return api->moi(); }

extern "C" int api_adversaire() { return api->adversaire(); }

extern "C" bool api_annuler() { return api->annuler(); }

extern "C" int api_tour_actuel() { return api->tour_actuel(); }

extern "C" void api_afficher_erreur(erreur v) { api->afficher_erreur(v); }
...
extern "C" void api_afficher_position(position v) { api->afficher_position(v); }

extern "C" void api_afficher_dimension(dimension v) {
  api->afficher_dimension(v);
}

extern "C" void api_afficher_aigle(aigle v) { api->afficher_aigle(v); }
